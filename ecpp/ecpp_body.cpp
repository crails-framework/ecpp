...
const string_view escaped_end_delimiter = "%%>";
const string_view escaped_begin_delimiter = "<%%";
const string_view escaped_begin_delimiter_with_line_return = "\n<%%";
...
{
  if (try_to_replace_and_advance(escaped_begin_delimiter_with_line_return, "\\n<%"));
  else if (try_to_replace_and_advance(escaped_begin_delimiter, "<%"));
  else if (try_to_replace_and_advance("\"", "\\\""));
...
{
  if (try_to_replace_and_advance(escaped_end_delimiter, end_delimiter));
  else if (try_to_replace_and_advance(trim_end_delimiter, get_end_delimiter_replacement()))
  {
    context = RawContext;
